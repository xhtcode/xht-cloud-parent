...
public class GenVue3AddOrUpdateTemplateContext extends TemplateContext<GenVue3AddOrUpdate> {


    public GenVue3AddOrUpdateTemplateContext(final String packageName, final String path) {
        super("", "components/add-or-update", FileType.VUE, "vue3/add-or-update.vm", packageName, path);
    ...
    public boolean support(Annotation annotation) {
        return annotation instanceof GenVue3AddOrUpdate;
    }
     ...
     */
    @Override
    public void execute(TemplateColumn.TemplateColumnBuilder builder, GenVue3AddOrUpdate annotation, Field filedInfo) {
    ...
    public void execute(GenCodeInfo application) {
        GeneratorUtils.execute(application, getPageName(), "components/add-or-update","addOrUpdatePackage");
    }
