...
public class DeviceClientAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        // 执行时肯定是设备码流程
        DeviceClientOAuth2ClientAuthenticationToken deviceClientAuthentication =
                (DeviceClientOAuth2ClientAuthenticationToken) authentication;
        ...
        return new DeviceClientOAuth2ClientAuthenticationToken(registeredClient,
    ...
    public boolean supports(Class<?> authentication) {
        // 只处理设备码请求
        return DeviceClientOAuth2ClientAuthenticationToken.class.isAssignableFrom(authentication);
    }
