package com.xht.cloud.framework.security.oauth2.server.authorization.token;
...
public class CustomAccessTokenGenerator implements OAuth2TokenGenerator<OAuth2AccessToken> {
    ...
    public OAuth2AccessToken generate(OAuth2TokenContext context) {
        ...
        if (Objects.nonNull(authorizationGrantType)){
            claimsBuilder.claim(OAuth2ParameterNames.GRANT_TYPE,authorizationGrantType.getValue());
        }
        // @formatter:on
