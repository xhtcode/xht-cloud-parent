...
/**
 * 描述 ：`系统角色菜单关联表`代码生成器所需实体
 *
 * @author : 小糊涂-代码生成器
 **/
@Data
@Module(value = "permissions", desc = "权限管理")
@GenInfoAnnotation(tableName = "sys_role_menu", url = "/sys/role/menu", tableComment = "系统角色菜单关联表", tableType = "BASE TABLE", tableSchema = "xht-cloud", engine = "InnoDB", createTime = "2023-03-01 19:20:07", updateTime = "")
public class SysRoleMenu {
    ...
    @GenSql
    @GenFileWrapper
    @FiledInfo(value = "role_id", describe = "", columnDefault = "", length = 36, isNullable = true, dbType = "varchar")
    ...
    @GenSql
    @GenFileWrapper
    @FiledInfo(value = "menu_id", describe = "", columnDefault = "", length = 36, isNullable = true, dbType = "varchar")
