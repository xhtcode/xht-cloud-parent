...
@GenInfoAnnotation(tableName = "sys_dept", url = "/sys/dept", tableComment = "部门", tableType = "BASE TABLE", tableSchema = "xht-cloud", engine = "InnoDB", createTime = "2023-07-06 12:24:09", updateTime = "")
public class SysDept {
    ...
    @GenSql
    @GenFileWrapper
    @FiledInfo(value = "parent_id", describe = "父id", columnDefault = "", length = 36, isNullable = true, dbType = "varchar")
    ...
    @GenSql
    @GenFileWrapper
    @FiledInfo(value = "director_id", describe = "指定主管ID(用户id)", columnDefault = "", length = 36, isNullable = false, dbType = "varchar")
    ...
    @GenSql
    @GenFileWrapper
    @FiledInfo(value = "dept_name", describe = "部门名称", columnDefault = "", length = 255, isNullable = true, dbType = "varchar")
    ...
    @GenSql
    @GenFileWrapper
    @FiledInfo(value = "dept_code", describe = "部门编码", columnDefault = "", length = 255, isNullable = true, dbType = "varchar")
    ...
    @GenSql
    @GenFileWrapper
    @FiledInfo(value = "dept_type", describe = "部门分类(0-境内 1境外)", columnDefault = "", length = 255, isNullable = true, dbType = "varchar")
    ...
    @GenSql
    @GenFileWrapper
    @FiledInfo(value = "dept_leader", describe = "部门负责人", columnDefault = "", length = 255, isNullable = false, dbType = "varchar")
    ...
    @GenSql
    @GenFileWrapper
    @FiledInfo(value = "dept_tel", describe = "联系电话", columnDefault = "", length = 255, isNullable = false, dbType = "varchar")
    ...
    @GenSql
    @GenFileWrapper
    @FiledInfo(value = "dept_sort", describe = "排序", columnDefault = "0", length = 0, isNullable = false, dbType = "int")
    ...
    @GenSql
    @GenFileWrapper
    @FiledInfo(value = "dept_status", describe = "部门状态（0停用1正常）", columnDefault = "", length = 1, isNullable = true, dbType = "char")
    ...
    @GenSql
    @GenFileWrapper
    @FiledInfo(value = "description", describe = "部门描述", columnDefault = "", length = 65535, isNullable = false, dbType = "text")
