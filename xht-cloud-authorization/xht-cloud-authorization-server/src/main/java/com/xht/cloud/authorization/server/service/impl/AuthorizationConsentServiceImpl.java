...
import com.xht.cloud.authorization.server.repository.AuthorizationConsentRepository;
...
public class AuthorizationConsentServiceImpl implements AuthorizationConsentService {
    ...
    public AuthorizationConsentServiceImpl(AuthorizationConsentRepository authorizationConsentRepository, RegisteredClientRepository registeredClientRepository) {
    ...
    private OAuth2AuthorizationConsent toObject(AuthorizationConsentDO authorizationConsent) {
    ...
    private AuthorizationConsentDO toEntity(OAuth2AuthorizationConsent authorizationConsent) {
        AuthorizationConsentDO entity = new AuthorizationConsentDO();
