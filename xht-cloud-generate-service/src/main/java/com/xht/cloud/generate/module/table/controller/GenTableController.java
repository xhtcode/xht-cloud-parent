...
public class GenTableController {
    ...
    @PostMapping
    public R<Boolean> create(@Validated(Create.class) @RequestBody GenTableAddRequest addRequest) {
        genTableService.create(addRequest);
        return ok(true);
    }
    ...
    @PutMapping
    public R<Boolean> update(@Validated(Update.class) @RequestBody GenTableUpdateRequest updateRequest) {
