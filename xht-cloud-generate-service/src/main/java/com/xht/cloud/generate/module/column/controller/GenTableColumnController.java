...
public class GenTableColumnController {
    ...
    @PostMapping
    public R<Boolean> create(@Validated(Create.class) @RequestBody GenTableColumnAddRequest addRequest) {
        genTableColumnService.create(addRequest);
        return ok(true);
    }
    ...
    @PutMapping
    public R<Boolean> update(@Validated(Update.class) @RequestBody GenTableColumnUpdateRequest updateRequest) {
