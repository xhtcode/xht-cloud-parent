...
public class GenCodeTemplateController {
    ...
    @PostMapping
    public R<Boolean> create(@Validated(Create.class) @RequestBody GenCodeTemplateAddRequest addRequest) {
        genCodeTemplateService.create(addRequest);
        return ok(true);
    }
    ...
    @PutMapping
    public R<Boolean> update(@Validated(Update.class) @RequestBody GenCodeTemplateUpdateRequest updateRequest) {
