...
import com.xht.cloud.generate.module.table.controller.request.GenTableRequest;
...
public class GenDatabaseController {
    ...
    @PostMapping
    public R<Boolean> create(@Validated(Create.class) @RequestBody GenDatabaseAddRequest addRequest) {
        genDatabaseService.create(addRequest);
        return ok(true);
    }
    ...
    @PutMapping
    public R<Boolean> update(@Validated(Update.class) @RequestBody GenDatabaseUpdateRequest updateRequest) {
