package com.xht.cloud.generate.module.table.dao.wrapper;
...
public final class GenTableWrapper implements EntityWrapper<GenTableDO> {
     ...
     * 私有化构造器
     */
    private GenTableWrapper() {
    }

    /**
     * 获取实例
     */
    public static GenTableWrapper getInstance() {
    ...
    private enum Instance {
        ...
        private final GenTableWrapper wrapper;

        Instance() {
            wrapper = new GenTableWrapper();
        }

        public GenTableWrapper getInstance() {
            return wrapper;
        }
    }
