...
public class GenCodeBaseClassController {
    ...
    @PostMapping
    public R<Boolean> create(@Validated(Create.class) @RequestBody GenCodeBaseClassAddRequest addRequest) {
        genCodeBaseClassService.create(addRequest);
        return ok(true);
    }
    ...
    @PutMapping
    public R<Boolean> update(@Validated(Update.class) @RequestBody GenCodeBaseClassUpdateRequest updateRequest) {
