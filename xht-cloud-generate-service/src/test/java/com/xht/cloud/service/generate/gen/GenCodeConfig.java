...
/**
 * 描述 ：`代码生成器-配置中心`代码生成器所需实体
 *
 * @author : 小糊涂-代码生成器
 **/
@Data
@Module(value = "config", desc = "")
@GenInfoAnnotation(tableName = "gen_code_config", url = "/gen/code/config", tableComment = "代码生成器-配置中心", tableType = "BASE TABLE", tableSchema = "xht-cloud-generate", engine = "InnoDB", createTime = "2023-12-01 16:02:02", updateTime = "")
public class GenCodeConfig {
    ...
    @GenSql
    @GenFileWrapper
    @FiledInfo(value = "config_name", describe = "配置名称", columnDefault = "", length = 255, isNullable = false, dbType = "varchar")
    ...
    @GenSql
    @GenFileWrapper
    @FiledInfo(value = "config_desc", describe = "配置描述", columnDefault = "", length = 255, isNullable = false, dbType = "varchar")
    ...
    @GenSql
    @GenFileWrapper
    @FiledInfo(value = "config_sort", describe = "排序", columnDefault = "", length = 0, isNullable = false, dbType = "int")
    ...
    @GenSql
    @GenFileWrapper
    @FiledInfo(value = "config_info", describe = "配置详情", columnDefault = "", length = -1, isNullable = false, dbType = "longtext")
