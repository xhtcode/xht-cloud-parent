...
/**
 * 描述 ：`代码生成器-字段类型对应`代码生成器所需实体
 *
 * @author : 小糊涂-代码生成器
 **/
@Data
@Module(value = "type", desc = "")
@GenInfoAnnotation(tableName = "gen_column_type", url = "/gen/column/type", tableComment = "代码生成器-字段类型对应", tableType = "BASE TABLE", tableSchema = "xht-cloud-generate", engine = "InnoDB", createTime = "2023-12-04 19:26:13", updateTime = "")
public class GenColumnType {
    ...
    @GenSql
    @GenFileWrapper
    @FiledInfo(value = "db_label", describe = "数据库类型", columnDefault = "", length = 255, isNullable = true, dbType = "varchar")
    ...
    @GenSql
    @GenFileWrapper
    @FiledInfo(value = "db_value", describe = "数据库字段类型", columnDefault = "", length = 255, isNullable = false, dbType = "varchar")
    ...
    @GenSql
    @GenFileWrapper
    @FiledInfo(value = "label", describe = "语言类型", columnDefault = "", length = 255, isNullable = false, dbType = "varchar")
    ...
    @GenSql
    @GenFileWrapper
    @FiledInfo(value = "value", describe = "代码类型", columnDefault = "", length = 255, isNullable = false, dbType = "varchar")
